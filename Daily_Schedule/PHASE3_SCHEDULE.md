...
> **현행화 기준(2026.09.12 KST):** 최종 발표 완료, 공개 운영 서비스 확인, AWS 프런트엔드 배포와 로컬 Docker 재시작 후 복구 검증까지 완료했습니다. 17장 PPT·10분 노트·약 3분 56초 통합 MP4는 발표 산출물로 확정했습니다.
> **발표 입력:** 더미영상·가상 텔레메트리 기반 시연을 사용합니다. 실내 실기체 운용 대신 Drone-Eye 별도 DEMO를 소개하며, 09.09 오전 스마트폰 위치·방향 실센서 송수신을 별도로 확인했습니다. 카메라 재시험은 보류 상태입니다.
...
- [x] README·일정표 현행화
- [x] Gamma 카드의 실제 발표자 노트 저장 확인
- [x] 실제 발표 속도 기준 리허설과 제출·발표 완료 확인
- [x] 공개 대시보드·발표용 영상 링크를 README에 등록
...
## 09.09 오전 추가 검증 — 스마트폰 실센서

- [x] 카메라 없는 센서 송신과 PC 수신 시각 갱신 확인
- [x] 스마트폰 회전·기울임에 따른 방위각·피치·롤 변화 확인
- [x] 관제에 방향값 및 기체 운용 상태와 별도의 수신 상태 표시 반영(PR #26)
- [x] 사용자 송신 중지 및 마지막 수신 09:32:36 KST 확인(사용자 보고)
- [ ] 실기체 비행·카메라 통합·장시간 연결 안정성·센서 정확도 교정 검증

[상세 검증 범위와 발표 문구](../docs/smartphone-telemetry-20260909.md). 이 추가 검증은 발표 영상 재제작이나 AI 모델 동결 해제를 의미하지 않습니다.
