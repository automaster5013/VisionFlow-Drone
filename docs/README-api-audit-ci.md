...
- 추적성 감사의 7개 검사키가 정확히 존재하고 모두 `PASS`여야 함
...
- `main`의 API·보안·Flyway·추적성 관련 소스가 변경된 push
...
4. 추적성 보고서의 `baseline-counts`, `migration-tables`, `entity-repository-mapping`, `foreign-key-contract`, `flow-operation-coverage`, `flow-table-coverage` 확인
