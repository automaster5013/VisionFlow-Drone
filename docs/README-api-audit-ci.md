...
4. 추적성 보고서의 삭제·세션 상관관계·세션 생명주기 정책 검사와 `baseline-counts`, `migration-tables`, `entity-repository-mapping`, `foreign-key-contract`, `flow-operation-coverage`, `flow-table-coverage` 확인
