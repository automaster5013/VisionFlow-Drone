...
const ACTION_LABELS: Record<AuditAction, string> = {
    ...
    OPERATOR_PAIRING_CREATED: "QR 페어링 생성",
    OPERATOR_PAIRING_CLAIMED: "QR 기기 연결 요청",
    OPERATOR_PAIRING_APPROVED: "QR 페어링 승인",
    OPERATOR_PAIRING_SESSION_ISSUED: "QR 모바일 세션 발급",
    OPERATOR_PAIRING_CANCELLED: "QR 페어링 취소",
